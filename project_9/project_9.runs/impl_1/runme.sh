...
HD_PWD='C:/Users/wingk/Desktop/Vivado/project_9/project_9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift4.tcl -notrace
