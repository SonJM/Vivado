...
HD_PWD='C:/Users/wingk/Desktop/Vivado/project_11/project_11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clcd.tcl
