...
HD_PWD='C:/Users/wingk/Desktop/Vivado/project_11/project_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clcd.tcl -notrace
