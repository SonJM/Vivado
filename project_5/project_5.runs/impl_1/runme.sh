...
HD_PWD='C:/Users/wingk/Desktop/Vivado/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dec3x8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dec3x8.tcl -notrace
