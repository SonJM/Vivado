...
HD_PWD='C:/Users/wingk/Desktop/Vivado/project_8/project_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnt4.tcl -notrace
